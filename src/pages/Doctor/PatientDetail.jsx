          ...
          <div className="flex items-center">
            ...
            <div className="flex w-5/6">
              <div className="grid grid-cols-4 gap-0 border-r pe-16 ps-16 w-[80%]">
                <div>
                  <p className="text-gray-500 new-xl:text-base new-lg:text-sm">
                    Patient Name
                  </p>
                  <p className="font-medium new-xl:text-base  new-lg:text-sm">
                    {displayData.name}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium capitalize new-xl:text-base  new-lg:text-sm">
                    {displayData.gender}
                  </p>
                </div>
                <div>
              ...
              <div className="ps-6 w-[20%]">
                <div className="pb-5">
                  <p className="text-gray-500 pb-1 new-xl:text-base new-lg:text-sm">
                    Country
                  </p>
                  <p className="font-medium new-xl:text-base new-lg:text-sm">
                    {displayData.country}
