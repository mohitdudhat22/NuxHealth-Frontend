...
export const MedicalHistory = () => {
    ...
    const MedicaltData = [
        {
            ...
            "date": "2022-01-02",
            "patientIssue": "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-."
        },
        {
    ...
    return (
        <>
            <NHCard
                title={<span className='text-[#030229] text-[26px] font-semibold'>Medical History</span>}
            >
