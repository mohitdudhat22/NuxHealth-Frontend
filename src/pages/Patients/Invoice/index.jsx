  ...
  return (
    <div className="invoice">
      ...
      <NHCard className="header-card">
        ...
        <p className="flex justify-between text-4xl font-semibold">
          Dr. {bill.doctorId.fullName}
          <div className="flex flex-col items-end">
            <span className="text-lg font-medium">
              <strong>Bill No:</strong> {bill.billNumber}
            </span>
            <span className="text-lg font-medium">
              <strong>Date:</strong> {moment(bill.date).format("DD/MM/YYYY")}
            </span>
            <span className="text-lg font-medium">
              <strong>Bill Time:</strong>{" "}
              {moment(bill.time, "h:mm:ss a").format("hh:mm A")}
            </span>
          </div>
        </p>
        ...
        <div className="patient-details">
          <p className="text-lg font-medium">
            <strong>Name:</strong> {bill.patientId.fullName}
          </p>
          <p className="text-lg font-medium">
            <strong>Gender:</strong> {bill.patientId.gender}
          </p>
          <p className="text-lg font-medium">
            <strong>Age:</strong> {bill.patientId.age} Years
          </p>
          <p className="text-lg font-medium">
            <strong>Address:</strong> {bill.patientId.address.fullAddress}
          </p>
        </div>
        <div className="appointment-details">
          <p className="text-lg font-medium">
            <strong>Disease Name:</strong> {bill.appointmentId.dieseas_name}
          </p>
          <p className="text-lg font-medium">
            <strong>Phone Number:</strong> {bill.patientId.phone}
          </p>
          <p className="text-lg font-medium">
      ...
      {bill.paymentType !== "Cash" && (
        <NHCard className="footer-card">
          ...
          <NHButton text="Pay Now" onClick={() => alert("Payment initiated!")}>
            Pay Now
          </NHButton>
        </NHCard>
      )}
