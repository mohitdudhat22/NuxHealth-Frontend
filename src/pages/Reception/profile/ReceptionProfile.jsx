                            ...
                            <div className="content flex bg-white rounded-[15px] p-[20px] shadow-2xl ">
                                ...
                                <div className="right new-xxl:w-[77%] new-xl:w-[75%] new-lg:w-[73%] ps-[20px]">
                                    <Routes>
                                        ...
                                        <Route path="changePassword" element={<ReceptionProfileChangePassword />} />
                                        <Route path="termsCondition" element={<ReceptionProfileTermsCondition />} />
                                        <Route path="privacyPolicy" element={<ReceptionProfilePrivacyPolicy />} />
                                    </Routes>
                                </div>
                            </div>
                        </div>
