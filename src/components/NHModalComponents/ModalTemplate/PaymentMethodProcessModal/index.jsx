    ...
    >
      <form>
        <div className="">
            ...
            <div className="flex justify-between items-center border border-[#A7A7A7] py-[12px] px-[14px] rounded-2xl">
              <div className="left flex justify-between items-center ">
                <div className="icon">
                  ...
                  >
                    <path
                      d="M7.51473 15.0806C11.4332 15.0806 14.6097 11.904 14.6097 7.98559C14.6097 4.06715 11.4332 0.890625 7.51473 0.890625C3.59629 0.890625 0.419762 4.06715 0.419762 7.98559C0.419762 11.904 3.59629 15.0806 7.51473 15.0806Z"
                      fill="#FF6041"
                    />
                  </svg>
                </div>
                <div className="details pl-3">
                  <p className="text-[#141414] text-[18px] font-bold">
                    Master Card
                  </p>
                </div>
              </div>
          ...
          <div className="py-3 flex justify-between align-center">
            <div className="w-[47%]">
              <NHDatePicker label={"Expiry Date*"} />
            </div>
            <div className="w-[47%]">
              <NHInput label={"CVV*"} placeholder={"123"} />
            </div>
          </div>
