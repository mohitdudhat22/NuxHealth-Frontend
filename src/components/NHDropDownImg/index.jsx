...
export const NHDropDownImg = ({
  ...
  return (
    ...
    >
      <button
        className={clsx(
          styles.dropDwnButton,
          "flex items-center shadow-none border-0 bg-transparent gap-md cursor-pointer"
        )}
      >
        ...
        <div className={styles.dropDwnContent}>
          <h5 className={"block fw-bold leading-normal mb-xs"}>{name}</h5>
          <p
            className={clsx(
              styles.dropDwnSubTitle,
              "text-start leading-normal"
            )}
          >
            {position}
          </p>
